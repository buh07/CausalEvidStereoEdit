#!/bin/bash
# GPU 0: Gemma-2-2B core validity pack (A2/A1/B1/D1 prerequisites + B1 + D1)
set -euo pipefail
...
MIX_E1="results/01_layerwise_probing/2026-05-07/run-011"
MIX_E2="results/02_component_dla/2026-05-07/run-012"
MIX_E3="results/03_attribution_patching/2026-05-07/run-020"

rm -f results/core_done_g0.flag

echo "=== GPU0 CORE START $(date) ==="
...
echo "--- Exp11 B1 (Gemma gender/profession sweep) ---"
...
touch results/core_done_g0.flag
echo "=== GPU0 CORE DONE $(date) ==="
