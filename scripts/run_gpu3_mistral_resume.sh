#!/bin/bash
# GPU 3 — Mistral-7B-v0.1 Exp03 onwards (recovery after OOM at pairs-limit 150)
# Exp01 and Exp02 are already done:
...
echo "=========================================="
echo "GPU 3 — Mistral-7B-v0.1 RESUME from Exp03"
echo "Started: $(date)"
echo "=========================================="

echo "--- Exp 03: Attribution patching (60 pairs, OOM-safe) ---"
python experiments/03_attribution_patching.py \
    --model "$MODEL_MISTRAL" --device "$DEVICE" --torch-dtype "$DTYPE_MISTRAL" \
    --pairs-limit 60 --top-k 20 \
...
echo ""
echo "=========================================="
echo "GPU 3 Mistral COMPLETE: $(date)"
echo "=========================================="
