...
LOG_FILE="results/${RUN_TAG}/log_olmo7b_sharded_resume.txt"
...
log_msg "OLMo 7B sharded resume start | RUN_TAG=$RUN_TAG"
...
log_msg "OLMo 7B sharded resume done"
