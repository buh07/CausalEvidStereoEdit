#!/bin/bash
# GPU 0 — Gemma-2-2B extended experiments
# Runs: Exp04-extended (strict controls, bootstrap, on-manifold), 07, 08, 09, 12
set -euo pipefail
...
echo "=========================================="
echo "GPU 0 — Gemma-2-2B Extended Experiments"
echo "Started: $(date)"
echo "=========================================="
...
echo "--- Exp12: local geometry atlas (CPU, runs on this GPU node) ---"
...
echo ""
echo "=========================================="
echo "GPU 0 — Gemma-2-2B COMPLETE: $(date)"
echo "=========================================="
