#!/bin/bash
# GPU 2 — Llama-3.2-3B: fix2 re-runs
# Fixes: Exp04 on-manifold (was patching trait_token_position; now projects direction at prediction_position)
#        Exp10 path mediation (was patching trait_token_position; redesigned with direction projection + geometric probe)
set -euo pipefail
...
echo "=========================================="
echo "GPU 2 — Llama-3.2-3B Fix2 Re-runs"
echo "Started: $(date)"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "GPU 2 — Llama-3.2-3B Fix2 COMPLETE: $(date)"
echo "=========================================="
